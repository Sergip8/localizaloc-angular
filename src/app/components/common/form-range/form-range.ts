    ...
    template: `
     <form class="max-w-sm mx-auto" [formGroup]="formGroup" (submit)="submit()">
        ...
        <div class="flex items-center justify-center w-48">
          ...
          <button type="submit" [disabled]="formGroup.invalid" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-1 py-2.5 ms-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <svg
